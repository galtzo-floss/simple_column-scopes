# kettle-jem:freeze
# To retain chunks of comments & code during simple_column-scopes templating:
# Wrap custom sections with freeze markers (e.g., as above and below this comment chunk).
# simple_column-scopes will then preserve content between those markers across template runs.
# kettle-jem:unfreeze
